...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 34, 20, 934);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(34:16) {#if run.periodName === name}",
    		ctx
    	});
    ...
    // (24:8) {#each processesName as name, index}
    function create_each_block_1(ctx) {
    	...
    	const block = {
            ...
            `);
    			...
    			add_location(div, file$4, 24, 12, 658);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:8) {#each processesName as name, index}",
    		ctx
    	});
    ...
    // (51:8) {#each Array(cols) as _, index}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 51, 12, 1576);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:8) {#each Array(cols) as _, index}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
            ...
            `);
    			...
    			add_location(div0, file$4, 60, 8, 1830);
        ...
        `);
    			...
    			add_location(div1, file$4, 16, 4, 475);
    			attr_dev(div2, "class", "component svelte-o5p54z");
    			add_location(div2, file$4, 15, 0, 446);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*runs*/ 1) {
    			...
    			$$invalidate(2, periodStamps = [0, ...runs.map(run => [run.periodStart, run.periodEnd]).flat()]);
    		}
    	};
    ...
    function SortestJobFirst(processes, options) {
        ...
        while (arrivedProcessesAtCurrentTime.length > 0) {
            ...
            let nextProcessArrivalTime = (_b = (_a = processes[0]) === null || _a === void 0 ? void 0 : _a.arrivalTime) !== null && _b !== void 0 ? _b : -1;
            time = Math.max(nextProcessArrivalTime, time + firstProcess.burstTime);
    ...
    function ShortestRemainingTimeFirst(processes, options) {
        ...
        while (processes.length > 0 || arrivedProcessesAtCurrentTime.length > 0) {
            ...
            if (processes.length > 0) {
                ...
                let nextProcessArrivalTime = (_a = processes[0]) === null || _a === void 0 ? void 0 : _a.arrivalTime;
                ...
                time = Math.max(nextProcessArrivalTime, time + timeToExecute);
            }
            else {
                let timeToExecute = firstProcess.remainingTime;
                firstProcess.execute(timeToExecute, time);
                time += timeToExecute;
            }
    ...
    function FirstComeFirstServed(processes, options) {
        ...
        processes.forEach((process) => {
            const executeTime = Math.max(time, process.arrivalTime);
            process.execute(process.burstTime, executeTime);
            time = executeTime + process.burstTime;
        });
        return processes;
    }
    // Priority Scheduling
    ...
    function RoundRobin(processes, options) {
        ...
        while (processes.length > 0 || arrivedProcessesAtCurrentTime.length > 0) {
            ...
            let timeToNextProcessArrival = (_c = (_b = processes[0]) === null || _b === void 0 ? void 0 : _b.arrivalTime) !== null && _c !== void 0 ? _c : -1;
            firstProcess.execute(timeToExecute, time);
            time = Math.max(timeToNextProcessArrival, time + timeToExecute);
            // add all arrived processes to arrived processes list
            if (processes.length > 0) {
                let arrivedProcesses = processes.filter((process) => {
                    return process.arrivalTime <= time;
    ...
    function HighestResponseRatioNext(processes, options) {
        ...
        while (processes.length > 0 || arrivedProcessesAtCurrentTime.length > 0) {
            ...
            // execute process for the minimum time between burst time and time to next process arrival time
            let timeToExecute = firstProcess.burstTime;
            let timeToNextProcessArrival = (_b = (_a = processes[0]) === null || _a === void 0 ? void 0 : _a.arrivalTime) !== null && _b !== void 0 ? _b : -1;
            firstProcess.execute(timeToExecute, time);
            time += Math.max(timeToNextProcessArrival, timeToExecute);
            // add all arrived processes to arrived processes list
            if (processes.length > 0) {
                let arrivedProcesses = processes.filter((process) => {
                    return process.arrivalTime <= time;
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$3, 50, 24, 1744);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 41, 16, 1313);
    			add_location(li, file$3, 40, 12, 1291);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$3, 38, 4, 1225);
    			attr_dev(div, "class", "algo");
    			add_location(div, file$3, 37, 0, 1201);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-1ixm21b");
    			...
    			attr_dev(button1, "class", "svelte-1ixm21b");
    			add_location(button1, file$1, 17, 4, 418);
    			attr_dev(div0, "class", "main svelte-1ixm21b");
    			add_location(div0, file$1, 6, 0, 126);
    			attr_dev(p2, "id", "title");
    			attr_dev(p2, "class", "svelte-1ixm21b");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*dialogOpen*/ 1 && div6_class_value !== (div6_class_value = "" + (null_to_empty(/*dialogOpen*/ ctx[0] ? "donate" : "donate close") + " svelte-1ixm21b"))) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			p = element("p");
    			t6 = text("Design and created by Văn Viết Hiếu Anh - All images from\r\n            ");
    			a = element("a");
    			i = element("i");
    			t7 = text(" Unsplash");
    			attr_dev(div0, "class", "divider");
    			add_location(div0, file, 117, 12, 3143);
    			attr_dev(div1, "class", "options");
    			add_location(div1, file, 111, 8, 2957);
    			attr_dev(div2, "class", "table");
    			add_location(div2, file, 120, 8, 3235);
    			attr_dev(i, "class", "fa-brands fa-unsplash");
    			add_location(i, file, 136, 16, 3743);
    			attr_dev(a, "href", "https://unsplash.com/");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file, 132, 12, 3629);
    			attr_dev(p, "class", "credit");
    			add_location(p, file, 130, 8, 3526);
    			attr_dev(div3, "class", "container");
    			add_location(div3, file, 109, 4, 2897);
    			add_location(main, file, 108, 0, 2885);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let inputProcesses = [
    		new Process("P-1", 1, 4, 2),
    		new Process("P-2", 6, 7, 1),
    		new Process("P-3", 14, 8, 5),
    		new Process("P-4", 15, 3, 4),
    		new Process("P-5", 15, 6, 3)
    	];
